...
console.log(exclaimThree('Oh hello there'))
...
let nameGreeting = nameCheck('Andy')
...
console.log(emailCheck('asdfasdfa@asdfasdfads'))
...
/*
  ...
  Your function should take in a single parameter, which is the amount of gold you are willing to spend. Your function should return a total amount of chocolate frogs you were able 
  to purchase. Create a variable called `totalFrogs` and set it equal to your function invoked, passing in the amount of gold you are willing to spend.
*/
...
const buyFrogs = (gold) =>{
  if (gold < 3){
    return 'Not enough gold for any frogs'
  } else {
    return gold/3
  }
}

let totalFrogs = buyFrogs(5)
console.log(totalFrogs)


////////////////// PROBLEM 20 ////////////////////
/*
  You might have noticed a slight bug in the previous problem. If you were to pass in 4 gold, the function would return to you 1.3333... However, you can't really go to a store and 
  by 1.333 products. You would just be able to purchase 1 product. Re-write the function you used in the previous problem (give it the same name, just add a 2 to the end of it) 
  that fixes this bug. Invoke the function and store the returned value to a variable called `totalFrogs2`.
*/

//CODE HERE

const buyFrogsTwo = (gold) =>{
  if (gold < 3){
    return 'Not enough gold for any frogs'
  } else if(gold % 3 === 0) {
    return gold/3
...
let totalFrogsTwo = buyFrogsTwo(10)
